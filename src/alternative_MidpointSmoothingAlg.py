...
def main():
    ...
    # ================================================================================================
    # run the midpoint smoothing algorithm
    # ================================================================================================
    # run_alg()

    # ================================================================================================
    # compute the speed error vs the adaptive linear regression method
    # ================================================================================================
    # compute_speed_err_ms_vs_lr()

    # ================================================================================================
    # compute the speed estimation error of midpoint smoothing algorithm
    # ================================================================================================
...
def compute_speed_err_ms_vs_lr():
    ...
    LR_file = '../workspace/May30_2017/figs/figs_MS/speed_LR.txt'
    MS_file = '../workspace/May30_2017/figs/figs_MS/speed_MS.txt'
    ...
    np.save('../workspace/May30_2017/s1_MS_detected_vehs.npy', _ms)
...
def compute_speed_err_vs_true():
    ...
    s1_true_file = '../workspace/May30_2017/CV_truth_v11_post.npy'

    # each item is a dict:  ['t_in',  't_out', 'distance', 'speed', 'closer_lane']
    s1_lr_file = '../workspace/May30_2017/s1_detected_vehs_post_combined.npy'

    # [mean_time (dt), slope, speed (mph)]
    s1_ms_file = '../workspace/0530_2017/s1_MS_detected_vehs.npy'
...
def run_alg():
    ...
    alg.run(norm_df, window_s=5.0, step_s=2.5, speed_range=speed_range,
            save_dir='../workspace/{0}/'.format(folder), sensor= 's1',
...
class MedianFit:
    ...
    def run(self, norm_df, window_s=5.0, step_s=2.5, speed_range=(1,60), save_dir='./', sensor='s1',
        ...
        np.save(save_dir + sensor + '_MS_detected_vehs.npy', _vehs)
        self._save_vehs_txt(_vehs, save_dir, sensor + '_MS_detected_vehs.txt')
        self._save_paras(save_dir, sensor + '_MS_detector_paras.txt')
