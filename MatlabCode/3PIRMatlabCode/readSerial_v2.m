...
% this is the new version, input data is
% PIR1_meas1, PIR2_meas1, PIR3_meas1, ...
% PIR1_meas8, PIR2_meas8, PIR3_meas8, ambient, counter
% Each measurement is 3 digits, 223 => 22.3 C
% ambient is also 3 digits, 242 => 24.2 C
% counter is between 00->99
...
num_meas = 3;
total_col = 27; %time, count, 25 data (24 pir + ambient)
...
% You may use arduino serial monitor to check this.
