...
class PIR3_converter:
    ...
    # assuming px = [0-191]
    def config(self, pixel_list=range(0,192)):
        print pixel_list
    ...
    def convert(self, line):
        ...
        if self.convert_flag is True:
            ...
            if not self.ptat_pir1 == 0:
                ...
                return [self.ts_pir1, self.ts_pir2, self.ts_pir3] + [self.ptat_pir1, self.ptat_pir2, self.ptat_pir3] + calc_temp_return
        return [-1]
...
class PIR2x16_converter:
    """
    converter for data from only PIR2, rows 2 and 3
    """
    def __init__(self):
    ...
    # pixel_list = [px1, px2, ..., pxn]
    # assuming px = [0-191]
    def config(self, pixel_list=range(80, 112)):
        print pixel_list
        # set convert_flag to appropriate value T/F
        self.convert_flag = True
        print "pixel conversion ON"
    ...
    def convert(self, line):
        ...
        if self.convert_flag is True:
            ...
            if not self.ptat_pir2 == 0:
                ...
                return [self.ts_pir2] + [self.ptat_pir2] + calc_temp_return
        return [-1]
