...
#if EXAMPLEALLSENSORSV3== BTESTALLSENSORSV3 
...
void loop()
{
     ...
     char destMacAdd[17] = "0013A2004099A76E";
	 char data[3] = "01";
     //sendUnicastSignalagain(data,destMacAdd);// send data to sink
	 broadcastSignalagain(data)	 ;
	 //handle received data 
