...
#define BTESTSENSORSCONNECTION 0

#define BTESTSENSORSCONNECTIONNULL 100


#define EXAMPLESENSORSCONNECTION BTESTSENSORSCONNECTIONNULL
...
*/
//EEPROM
#if EXAMPLESENSORSCONNECTION==BTESTSENSORSCONNECTION
...
uint16_t max_height_car = 160;  //Maximum height of the car
uint16_t min_height_car = 20;  //Minimum height of the car
int max_variation;
int first_variation;
...
float temp_threshold = 3.0; // 5 Celsius Degress as Threshold  
...
void do_packet(){
  ...
  packetID = random_delay(999);
	...
	packet_tosend[packet_pointer] = value_char[3];
	  packet_pointer++;
	//printf("String: %s\n",value_char);
	Utils.float2String(tempambient_ave,value_char,2);
	packet_tosend[packet_pointer] = value_char[0];
	  packet_pointer++;
	packet_tosend[packet_pointer] = value_char[1];
	  packet_pointer++;
...
if((count_vars<1)&&(count_vars_tempa<1)&&(count_vars_tempb<1)&&(count_vars_tempc<1)){
...
//Method to sort an array of float
...
void loop()
{
	...
	slave_add = 0x2a;
	tempobject=readMlx90614ObjectTemp(slave_add);
  printf("Temp sensor a: %f\n",tempobject);
	delay_ms(300);
	slave_add = 0x2b;
	tempobject=readMlx90614ObjectTemp(slave_add);
  printf("Temp sensor b: %f\n",tempobject);
	delay_ms(300);
	slave_add = 0x2c;
	tempobject=readMlx90614ObjectTemp(slave_add);
  printf("Temp sensor c: %f\n",tempobject);
	delay_ms(300);
// 	slave_add = 0x2d;
// 	tempobject=readMlx90614ObjectTemp(slave_add);
//   printf("Temp sensor d: %f\n",tempobject);
// 	delay_ms(300);
// 	slave_add = 0x2e;
// 	tempobject=readMlx90614ObjectTemp(slave_add);
//   printf("Temp sensor e: %f\n",tempobject);
// 	delay_ms(300);
// 	slave_add = 0x2f;
// 	tempobject=readMlx90614ObjectTemp(slave_add);
//   printf("Temp sensor f: %f\n",tempobject);
// 	delay_ms(300);
// 	
// 	flagsonar=readMb7076(&valuesonar);
// 	printf("Ultrasound: %d\n",valuesonar);
