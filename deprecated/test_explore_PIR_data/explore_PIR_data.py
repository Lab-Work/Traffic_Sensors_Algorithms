...
# PIR data file collected on Jun 25
file_name_str = '/Users/Yanning/Dropbox/Sensor_code/PIR_code/SmartCone/database/datasetRaw06252015.csv'
# file_name_str = '/Users/Yanning/Dropbox/Sensor_code/PIR_code/SmartCone/database/datasetRaw06052015.csv'
...
# For 0605 data set
# all_pir.pir2.plot_time_series_of_pixel(1433465500, 1433466100, [(2,0),(2,8),(2,15)])

# For 0625 data set
# all_pir.pir2.plot_time_series_of_pixel(1433471500, 1433476000, [(2,0),(2,8),(2,15)])
all_pir.pir2.plot_time_series_of_pixel(1433471500, 1433471600, [(2,0),(2,8),(2,15)])


# all_pir.pir2.plot_heat_map_video(None, None, 30, 50, 8, None)
# all_pir.pir2.plot_heat_map_video(1433471500, 1433471600, 30, 50, 8, 16)
all_pir.pir2.plot_heat_map_video(1433471500, 1433471600, -5, 5, 8, 64)
